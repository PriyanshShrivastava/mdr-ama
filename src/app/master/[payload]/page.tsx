...
export default function MasterQrPage() {
  ...
  if (error) return <main className="shell compact"><section className="card error"><h1>Couldn&apos;t create this QR</h1><p>{error}</p><Link className="button" href="/create">Start again</Link></section></main>;
